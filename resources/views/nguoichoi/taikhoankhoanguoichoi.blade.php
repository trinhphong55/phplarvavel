            ...
            <div class="card-body">
                ...
                <table id="basic-datatable" class="table dt-responsive nowrap">
                    ...
                    <tbody>
                       ...
                       @foreach($nguoichoip as $nguoichoi)
                       <td>{{$nguoichoi->id}}</td>
                       ...
                       <form action="{{route('nguoichoimokhoanguoichoi',$nguoichoi->id)}}" method="post">
                       
                        @method('DELETE')
                         @csrf
                    
                         <td><button type="submit" name="" class="btn btn-danger waves-effect waves-light"><i class="fe-refresh-ccw"></i></button></td>
                          </form> 
